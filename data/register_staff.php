...
function register_staff($conn, $idCode)
{
            ...
            <div class="d-flex justify-content-between">
                <div class="w-75">
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            <input type="text" value="<?= $autoNameF ?>" name="first_name_kh" class="form-control" placeholder="First Name Khmer" required>
                        </div>
                        <div class="col-md-4">
                            <input type="text" name="middle_name_kh" class="form-control" placeholder="Middle Name Khmer">
                        </div>
                        <div class="col-md-4">
                            <input type="text" value="<?= $autoNameL ?>" name="last_name_kh" class="form-control" placeholder="Last Name Khmer" required>
                        </div>

                    </div>
                    <div class="row g-3 mb-3">
                        <div class="col-md-4">
                            <input type="text" value="<?= $autoNameEnF ?>" name="first_name_en" class="form-control" placeholder="First Name English" required>
                        </div>
                        <div class="col-md-4">
                            <input type="text" name="middle_name_en" class="form-control" placeholder="Middle Name English">
                        </div>
                        <div class="col-md-4">
                            <input type="text" value="<?= $autoNameEnL ?>" name="last_name_en" class="form-control" placeholder="Last Name English" required>
                        </div>
                    </div>
                </div>
